...
<!-- Jvectormap -->
<script src="<?php echo e(asset('js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>

<!-- EayPIE -->
<script src="<?php echo e(asset('js/plugins/easypiechart/jquery.easypiechart.js')); ?>"></script>
